                ...
                when (currentTab) {
                    ...
                    BottomNavTab.Installments -> {
                        InstallmentsChequesScreen(
                            ...
                            onPayInstallment = { inst, accountId -> viewModel.payInstallment(inst, accountId) },
                            ...
                            onPaySpecificInstallmentItem = { inst, item, accId -> viewModel.paySpecificInstallmentItem(inst, item, accId) },
                            ...
                            onMarkChequePassed = { cheque, accountId -> viewModel.markChequePassed(cheque, accountId) },
